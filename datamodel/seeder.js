...
module.exports = (listesService, articlesServices, userAccountService, partageService) => {
    return new Promise(async (resolve, reject) => {
            try {
                await userAccountService.dao.db.query("CREATE TABLE useraccount(id SERIAL PRIMARY KEY, displayname TEXT NOT NULL UNIQUE, login TEXT NOT NULL UNIQUE, challenge TEXT NOT NULL)")
